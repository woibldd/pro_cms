...
module.exports = {
  ...
  'mining': {
    ...
    how3: '3. Duration:',
    OverviewContent: 'The duration for the second round of BKSwap Trading Reward event: Dec. 20, 2021 at 01:00 - Dec. 24, 2021 at 23:00 (EST)',
    ...
    FQAContent1: 'The trading reward is calculated in real time, and users can check it at any time on the "Trading Reward" page. Users will receive their trading rewards for the previous day at 00:00 (EST) every day. For example: Users will receive trading rewards for Dec. 20, 2021 on Dec. 20, 2021 at 00:00 (EST). It will be the same for each following day. For the rewards for Dec. 25, 2021, users will receive them on Dec. 26, 2021 at 12:00 (PM) (exactly one day after the event ends).',
    ...
    FQAContent6: 'Users will receive their invitation rewards for the previous day at 00:00 (EST) every day.',
    about: 'About BKB',
    viewAll: 'View All',
    pickUp: 'Pick up',
    aboutContent1: 'Holding BKB will enjoy ecological governance rights, and it is also the identity proof of BitKeep\'s ecological payment method and membership rights.',
...
module.exports = {
  ...
  'mining': {
    ...
    Objectives11: ' 特定の日のBKSwapの合計取引金額が500万USDT相当以上1000万USDT相当以下の場合、契約ルールに従って、BitKeepはその日の取引手数料の200％に等しいBKBの合計を提供します。 その日の報酬。 当日にBKSwapトランザクションに参加したすべてのユーザーは、比例したシェアを獲得します（個々のユーザーのトランザクション量によって異なります）',
    ...
    how3: '3. 間隔:',
    OverviewContent: 'BKSwap Trading Rewardイベントの第2ラウンドの期間：2021年12月20日01：00- 2021年12月24日23:00（EST）',
    FQATitle: 'よくある質問（FAQ）',
    FQATitle1: '1. 報酬はいつ配布されますか？',
    FQAContent1: '取引報酬はリアルタイムで計算され、ユーザーは「取引報酬」ページでいつでも確認できます。 ユーザーは、前日の00:00（EST）に毎日取引報酬を受け取ります。 例：ユーザーは、2021年12月20日の00:00（EST）に2021年12月20日の取引報酬を受け取ります。 翌日も同じになります。 2021年12月25日の特典として、ユーザーは2021年12月26日の12:00（PM）（イベント終了のちょうど1日後）に特典を受け取ります。',
    ...
    FQAContent6: 'ユーザーは、前日の00:00（EST）に毎日招待報酬を受け取ります。',
    about: 'BKBについて',
    viewAll: 'すべて表示',
    pickUp: '選び出す',
...
module.exports = {
  ...
  'mining': {
    ...
    OverviewContent: 'Thời gian cho đợt thứ hai của sự kiện Phần thưởng giao dịch BKSwap: 01:00 ngày 20 tháng 12 năm 2021 - 23:00 ngày 24 tháng 12 năm 2021 (EST)',
    FQATitle: 'Câu hỏi thường gặp (FAQ)',
    FQATitle1: '1. Phần thưởng được phân phối khi nào?',
    FQAContent1: 'Phần thưởng giao dịch được tính theo thời gian thực và người dùng có thể kiểm tra bất kỳ lúc nào trên trang "Phần thưởng giao dịch". Người dùng sẽ nhận được phần thưởng giao dịch của họ cho ngày hôm trước vào lúc 00:00 (EST) hàng ngày. Ví dụ: Người dùng sẽ nhận được phần thưởng giao dịch vào ngày 20 tháng 12 năm 2021 vào ngày 20 tháng 12 năm 2021 lúc 00:00 (EST). Nó sẽ giống nhau cho mỗi ngày tiếp theo. Đối với phần thưởng cho ngày 25 tháng 12 năm 2021, người dùng sẽ nhận được chúng vào ngày 26 tháng 12 năm 2021 lúc 12:00 (CH) (chính xác một ngày sau khi sự kiện kết thúc).',
    ...
    FQAContent6: 'Người dùng sẽ nhận được phần thưởng lời mời của họ cho ngày hôm trước vào lúc 00:00 (EST) hàng ngày.',
    about: 'Về BKB',
    viewAll: 'Xem tất cả',
    pickUp: 'Đón',
