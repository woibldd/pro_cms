        ...
        this.$nextTick(() => {
          BitKeepInvoke.appMode((err, res) => {
            ...
            if (res == 1) {
              ...
              BitKeepInvoke.setIconAction(); //   },500)
            } else {
              this.theme = 0;
