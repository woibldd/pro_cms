<template>
  <div>
    ...
    <div v-else>
      <div class="img">
        <img :src="locale=='en' ? 'https://cdn.bitkeep.vip/u_b_3f5bfbf0-2fe2-11ec-877b-ddcbdd675082.png': 'https://cdn.bitkeep.vip/u_b_3f5d5b80-2fe2-11ec-877b-ddcbdd675082.png'" alt="">
      </div>
      <div class="text">
      ...
      <div class="airdrop">
        ...
        <p class="title">{{$t('airdrop.particlpation')}}</p>
        <p class="content">{{$t('airdrop.particlpation1')}}</p>
        <p class="content">{{$t('airdrop.particlpation2')}}</p>
        <p class="content">{{$t('airdrop.particlpation3')}}</p>
        <p class="content">{{$t('airdrop.particlpation4')}}</p>
        <p class="content">{{$t('airdrop.particlpation5')}}</p>
        <p class="title">{{$t('airdrop.rules')}}</p>
        <div class="ruleContent">
          <p class="content">{{$t('airdrop.rules1')}}</p>
      ...
      <div class="distribution">
        ...
        <div class="charts-img">
          <img src="https://cdn.bitkeep.vip/u_b_c014c440-30d0-11ec-9e24-8d799844d18f.png" alt="">
      ...
      <div class="more">
        ...
        <div class="more-line">
          <a href="https://www.bitkeep.com/" target="_blank">
            <img src="https://cdn.bitkeep.vip/u_b_ddcf2860-2bec-11ec-b5c0-c1ce5b0a2535.png" alt=""><span>{{$t('CbkbExchange.website')}}</span>
          </a>
        ...
        <div class="more-line">
          <a href="https://twitter.com/BitKeepOS" target="_blank">
            <img src="https://cdn.bitkeep.vip/u_b_ddcf4f71-2bec-11ec-b5c0-c1ce5b0a2535.png" alt=""> <span>{{$t('CbkbExchange.twitter')}}</span>
          </a>
          <van-icon name="arrow" class="setIcon"/>
        </div>
        <!--        <div class="more-line">-->
        ...
        <div class="more-line">
          <a href="https://t.me/bitkeep" target="_blank">
            <img src="https://cdn.bitkeep.vip/u_b_ddcf0150-2bec-11ec-b5c0-c1ce5b0a2535.png" alt=""> <span>{{$t('CbkbExchange.telegram')}}</span>
          </a>
          <van-icon name="arrow" class="setIcon"/>
        </div>
        <!--        <div class="more-line">-->
        ...
        <div class="more-line">
          <a :href="src" target="_blank">
            <img src="https://cdn.bitkeep.vip/u_b_ddceda40-2bec-11ec-b5c0-c1ce5b0a2535.png" alt=""> <span>{{$t('CbkbExchange.explorer')}}</span>
          </a>
          <van-icon name="arrow" class="setIcon"/>
        </div>
      </div>
...
export default {
  ...
  beforeMount() {
    this.isBitKeep &&
    BitKeepInvoke.setTitle(this.$t("airdrop.airdropTitle"));
  },
  methods:{
    // 获取地址cbkb地址
    async getBalance() {
