module.exports = {
    ...
    polygon: {
      ...
      rights: '权益',
      info1: '1.Mint 开启后 30 天内，每日随机挑选 100 位持有者，每位持有者空投 随机 枚 BKB 到云钱包',
      ...
      whiteTitle: '白名单特权',
      whiteTips1: '1、白名单用户在5月15日开启Mint',
      whiteTips2: '2、非白名单用户在5月16日开启Mint',
      ...
      faild: '失败',
      success: '成功',
      noNft: '暂时没有可以Ment的NFT',
      mentAlert: 'Ment数量不能小于0',
