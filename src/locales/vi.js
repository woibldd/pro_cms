module.exports = {
  ...
  'mining':{
    coundown: 'Đếm ngược',
    miningTitle: 'Khai thác giao dịch （Giai đoạn 1）',
    comingsoon: 'Sắp có',
    ...
    yesterdayRewards: 'Phần thưởng hôm qua',
    ...
    phase: 'Giai đoạn {v}',
    historyTitle: 'Dữ liệu lịch sử phần thưởng giao dịch',
    ...
    hold1: '1. Nhận chiết khấu đối với phí BitSwap.',
    hold2: '2.Thanh toán cho dịch vụ BitKeep NFT Market.',
    hold3: '3.Có được chức năng thanh toán của BitKeep Pools.',
    hold4: '4.Nhận chức năng miễn giảm thanh toán của BitKeep Pay.',
    hold5: '5.Nhận phần thưởng phiếu tăng lãi suất BitKeep Fin để hỗ trợ toàn bộ hệ sinh thái sản phẩm.',
    hold6: '6.Nhận miễn phí thanh toán trong hệ thống kinh doanh BitKeep.',
    hold7: '7.Nhận phần thưởng airdrop không thường xuyên trong các bể xi-rô BitKeep.',
    hold8: '8.Phần thưởng BKB StaKing',
