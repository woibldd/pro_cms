module.exports = {
  ...
  'mining':{
    coundown: '秒読み',
    miningTitle: 'トランザクションマイニング（フェーズ1）',
    comingsoon: '近日公開',
    inProgress: '進行中',
    ...
    eco: '生態系構築',
    hold: 'BKBエクイティを保有',
    hold1: '1.BitSwap料金の割引を取得します。',
    hold2: '2. BitKeepNFTマーケットサービスの支払い。',
    hold3: '3.BitKeepプールの支払い機能を取得します。',
    hold4: '4. BitKeepPayの支払い削減および免税機能を取得します。',
    hold5: '5.製品のエコロジー全体をサポートするために、BitKeepFinの金利引き上げクーポンの特典を取得します。',
    hold6: '6.BitKeepビジネスシステムで支払い免除を取得します。',
    hold7: '7.BitKeepシロッププールで不規則なエアドロップ報酬を取得します。',
    hold8: '8.BKBStaKingの報酬',
