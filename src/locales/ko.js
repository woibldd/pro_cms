module.exports = {
  ...
  'mining':{
    ...
    eco: '생태계 구축',
    hold: 'BKB 지분 보유',
    hold1: '1.BitSwap 수수료 할인을 받으세요.',
    hold2: '2.BitKeep NFT Market 서비스 비용을 지불하십시오.',
    hold3: '3.BitKeep Pools의 지불 기능을 얻으십시오.',
    hold4: '4.BitKeep Pay의 결제 감면 기능을 받아보세요.',
    hold5: '5.전체 제품 생태계를 지원하기 위해 BitKeep Fin 금리 인상 쿠폰 보상을 받으세요.',
    hold6: '6.BitKeep 비즈니스 시스템에서 지불 면제를 받으십시오.',
    hold7: '7.BitKeep 시럽 풀에서 불규칙한 에어드롭 보상을 받으세요.',
    hold8: '8.BKB 스테이킹 보상',
